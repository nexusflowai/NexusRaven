...
```bash
./scripts/evaluate_nexusraven.sh cve_cpe {inference endpoint url}
./scripts/evaluate_nexusraven.sh emailrep {inference endpoint url}
./scripts/evaluate_nexusraven.sh virustotal {inference endpoint url}
./scripts/evaluate_nexusraven.sh toolalpaca {inference endpoint url}
./scripts/evaluate_nexusraven.sh toolllm {inference endpoint url}
```

### GPT-3.5
```bash
./scripts/evaluate_gpt3_5.sh cve_cpe
./scripts/evaluate_gpt3_5.sh emailrep
./scripts/evaluate_gpt3_5.sh virustotal
./scripts/evaluate_gpt3_5.sh toolalpaca
./scripts/evaluate_gpt3_5.sh toolllm
```

### GPT-3.5 Instruct
```bash
./scripts/evaluate_gpt3_5_instruct.sh cve_cpe
./scripts/evaluate_gpt3_5_instruct.sh emailrep
./scripts/evaluate_gpt3_5_instruct.sh virustotal
./scripts/evaluate_gpt3_5_instruct.sh toolalpaca
./scripts/evaluate_gpt3_5_instruct.sh toolllm
```

### GPT-4
```bash
./scripts/evaluate_gpt4.sh cve_cpe
./scripts/evaluate_gpt4.sh emailrep
./scripts/evaluate_gpt4.sh virustotal
./scripts/evaluate_gpt4.sh toolalpaca
./scripts/evaluate_gpt4.sh toolllm
```

### ToolLLM
```bash
./scripts/evaluate_toolllm.sh cve_cpe
...
```bash
./scripts/evaluate_codellamainstruct.sh cve_cpe {inference endpoint url}
./scripts/evaluate_codellamainstruct.sh emailrep {inference endpoint url}
./scripts/evaluate_codellamainstruct.sh virustotal {inference endpoint url}
./scripts/evaluate_codellamainstruct.sh toolalpaca {inference endpoint url}
./scripts/evaluate_codellamainstruct.sh toolllm {inference endpoint url}
```
